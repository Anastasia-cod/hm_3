...
// let result = users.filter(el => el.registrationDate == '09.10.2021' || el.registrationDate == '10.10.2021')
// console.log(result)
...
//     if(person.registrationDate == '09.10.2021' || person.registrationDate == '10.10.2021'){
//         return true
//     }
// })
...
const people = users.filter(person => person.registrationDate == '09.10.2021' || person.registrationDate == '10.10.2021')
console.log(people)
...
const JSONString = fs.readFileSync('/Users/anastasiyazayats/Downloads/task2.json', "utf8");
const JSData = JSON.parse(JSONString);
JSData.push(dataToAdd);
const newJSONString = JSON.stringify(JSData, null, 2);
fs.writeFileSync('/Users/anastasiyazayats/Downloads/task2.json', newJSONString);
