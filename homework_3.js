...
const result = users.filter(person => person.registrationDate === '09.10.2021' || person.registrationDate === '10.10.2021')
console.log(result)
...
enterprises.forEach(element => console.log(element.name))
enterprises.forEach(element => console.log(element.departments))
